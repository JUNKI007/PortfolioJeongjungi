        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="bg-white/5 border border-white/10 rounded-sm overflow-hidden transition-all duration-300 hover:scale-[1.02] hover:bg-white/10">
            <div className="relative h-64 w-full">
              <Image src={`/Confidence.jpg`} alt="자신감 있는 사람" fill unoptimized className="object-cover" />
          ...
          <div className="bg-white/5 border border-white/10 rounded-sm overflow-hidden transition-all duration-300 hover:scale-[1.02] hover:bg-white/10">
            <div className="relative h-64 w-full">
              <Image src={`/Hobby.jpg`} alt="게임이 취미인 개발자" fill unoptimized className="object-cover" />
              <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent"></div>
          ...
          <div className="bg-white/5 border border-white/10 rounded-sm overflow-hidden transition-all duration-300 hover:scale-[1.02] hover:bg-white/10">
            <div className="relative h-64 w-full">
              <Image src={`/Leader.png`} alt="소통과 격려를 중요시하는 리더" fill unoptimized className="object-cover" />
              <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent"></div>
